...
class DashboardScreen extends Screen
{
    ...
    public function query(): iterable
    {
        return [
            'posts' => Post::filters()
                ->select('posts.id as id','posts.title','posts.hero','posts.aktif','posts.published_at','posts.kategori')
    ...
    {
        return 'Website Balai Karantina Pertanian Kelas II Yogyakarta';
    }
    ...
    public function layout(): iterable
    {
        return [
            Layout::metrics([
                'Berita Bulan Ini'    => 'metrics.posts',
                'Pengunjung Bulan Ini' => 'metrics.visitors',
                'Realisasi Anggaran' => 'metrics.orders',
                'Sertifikasi' => 'metrics.total',
            ]),
